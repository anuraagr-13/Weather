...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        URL weatherUrl = NetworkU.buildUrlForWeather();
        new FetchWeatherDetails().execute(weatherUrl);
        Log.i(TAG, "onCreate: weatherUrl:"+ weatherUrl);
        }

        class FetchWeatherDetails extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL...urls) {
            ...
            try {
                weatherSearchResults = NetworkU.getResponseFromHttpUrl(weatherUrl);
            } catch(IOException e){
                e.printStackTrace();
            }
        ...
        @Override
            ...
            if(weatherSearchResults != null && !weatherSearchResults.equals("")){
                ...
                while(itr.hasNext()) {
                    ...
                    Log.i(TAG, "onPostExecute" + weatherInIterator.getDate() +
